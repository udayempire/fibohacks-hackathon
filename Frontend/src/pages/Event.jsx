  ...
  return (
    <div className="relative w-full">
      ...
      >
        ...
        {/* Add padding-top to push content down */}
        <div className="flex mt-[100px] flex-col gap-8 w-full max-w-5xl mx-auto px-4 md:px-8">
          <div>
            <img
              src="event.png"
              alt="Event"
              className="mx-auto  h-80 rounded-md mt-[900px]"
            />
          ...
          <div className="flex flex-col gap-6 w-full px-4">
            ...
            <div className="space-y-2 bg-slate-200 p-4 rounded-md mb-4">
              ...
              <p>
                ...
                What do we have in store for you? 🎁<br/>
                🌍500+ Developers, Countless Possibilities!
                This year, CoinDCX is pushing boundaries like never before.With over 500 developers converging at theMarriott, Bengaluru, prepare to be part of history in the making.Collaborate and exchange ideas with like-minded builders who share your passion for pioneering change.<br/>
                💡Insights for Tomorrow<br/>
                Immerse yourself in riveting discussions, keynotes, and fireside chats with the industrys most influential leaders, entrepreneurs, and disruptors.<br/>
                Network with people building and disrupting standards in the industry.<br/>
                ...
                Whether you are a coding maestro working solo or a dynamic team with a shared vision, seize the opportunity to build on the chain of your choice.<br/>
                With a total of$100k in prize moneyup for grabs, your ingenuity is your greatest asset.<br/>
                Create something that resonates with the spirit of Web3 and elevate your chances of victory.<br/>
              </p>
            </div>
          </div>
        </div>
